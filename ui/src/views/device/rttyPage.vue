<!--
 * @Author: LPY
 * @Date: 2025-08-26 11:54:32
 * @LastEditors: LPY
 * @LastEditTime: 2025-08-26 14:25:38
 * @FilePath: \glkvm-cloud\web-ui\src\views\device\rttyPage.vue
 * @Description: 
-->
<template>
    ...
    <div id="terminal-pool">
        <RttyTerm v-for="id in terms" :key="id" :data-terminal-id="id" :devid="devid" :panelId="id" @split="handleSplitPanel" @close="handleClosePanel"/>
    </div>
</template>
